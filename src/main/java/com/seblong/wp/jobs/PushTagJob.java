...
public class PushTagJob implements Job{
	
	private final static Logger LOG = LoggerFactory.getLogger(PushJob.class);

	public final static String TRIGGER = "WISH_PUSH_TAG_TRIGGER";
	
	public final static String JOB = "WISH_PUSH_TAG_JOB";
